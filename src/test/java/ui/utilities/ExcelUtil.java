...
public class ExcelUtil {
    ...
    //This is a list of map. This takes the data as string and will return the data as a List of Map
    ...
    //=========writes the value to the excel file===============//
    ...
    public void setCellData(String value, int row, String columnName) {
